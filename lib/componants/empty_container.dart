          ...
          child: SizedBox(
            child: Column(
              ...
              children: [
                ...
                Text(subText ?? "It's like we cant find any results", textAlign: TextAlign.center , style: subStyle ?? AppTextStyles.w400.copyWith(fontSize: 14,color: AppColors.lightHeader),)
