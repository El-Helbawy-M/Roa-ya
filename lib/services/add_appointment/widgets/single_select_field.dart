    ...
    return Column(
      ...
      children: [
        ...
        GridView.builder(
          ...
          gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 3, childAspectRatio: 3, crossAxisSpacing: 8, mainAxisSpacing: 8),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: option.isSelected ? AppColors.mainColor.withOpacity(.2) : Colors.transparent,
          borderRadius: BorderRadius.circular(8),
        ),
        child: Center(
            child: Text(
          option.label ?? "",
          style: Theme.of(context).textTheme.subtitle1!.copyWith(color: option.isSelected ? AppColors.mainColor : Colors.black),
        )),
      ),
    );
  }
...
class SelectOption {
  SelectOption({this.label, this.value, this.isSelected = false});
  String? label;
  String? value;
  bool isSelected;
}
